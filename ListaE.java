...
public class ListaE {
	...
	public void inserirAlunoInicio(AlunoE a) {
		if (estaVazia())
			primeiro = ultimo = a;
		else {
			a.proximo = primeiro;
	...
	public void inserirNoFim(AlunoE a) {
		if (estaVazia())
			primeiro = ultimo = a;
		else {
			ultimo.proximo = a;
	...
	public void inserirNaPosicao(AlunoE a, int pos) {
...
//		aux.prox = a;
	...
	public void exibirLista() {
		AlunoE temp = primeiro;
		if (!estaVazia()) {
			for (int i = 0; i < tamanho; i++) {
				System.out.println("Aluno "+i+" | nome: "+temp.nome);
				temp = temp.proximo;
			}
		}
	}
	...
	public void removerAlunoPorNome(String nomeprocurado) {
		...
		AlunoE alunodafrente = primeiro;
		AlunoE alunodetras = null;
